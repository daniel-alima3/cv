...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _daniel-alima3.github.io/cv/_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/daniel-alima3/cv/raw/master/dalima_cv.pdf)")
}
```
-->
...
O código fonte utilizado pode ser encontrado [em github.com/nstrayer/cv](https://github.com/daniel-alima3/cv).

Última atualização foi em `r Sys.Date()`.
